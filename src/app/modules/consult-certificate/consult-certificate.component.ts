...
@Component({
  selector: 'app-consult-certificate',
  templateUrl: './consult-certificate.component.html',
  styleUrls: ['./consult-certificate.component.scss']
})
export class ConsultCertificateComponent implements OnInit {
